...
impl MultimodalConfig {
    ...
    /// A value of 0 for `max_images` disables the image-count cap.
...
pub struct RuntimeConfig {
    ...
    /// Optional OpenAI Codex / Responses reasoning effort override.
    #[serde(default)]
    pub codex_reasoning_effort: Option<String>,

    /// Optional OpenAI Codex / Responses service tier hint.
    #[serde(default)]
...
pub struct QQConfig {
    ...
    #[serde(default)]
    pub allowed_users: Vec<String>,
    /// Local directory for saving inbound QQ attachments. Defaults to `~/downloads/qq`.
    #[serde(default)]
    pub download_dir: Option<String>,
    /// QQ progress display mode: `final-only`, `draft-recall`, or `status-messages`.
    #[serde(default)]
...
"#;
        ...
        assert_eq!(
            parsed.runtime.codex_reasoning_effort.as_deref(),
            Some("medium")
        );
        assert_eq!(parsed.runtime.codex_service_tier.as_deref(), Some("fast"));
    }
